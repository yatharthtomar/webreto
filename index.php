        ...
        <div class="container">
         <!-- <a class="navbar-brand" href="index.html">
            ...
            <a class="navbar-brand" href="index.php">
             <h1><span id = brandname1>Web</span><span id = "brandname2">Reto.</span></h1>
             </a>
          ...
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <ul class="navbar-nav ml-auto" id ="navbarnaya">
            ...
            <li class="nav-item active mr-3">
           <a class="nav-link" href="#naacho">Contact</a>
            </li>
            </li>
            <li class="nav-item active mr-3">
...
<div id = "services">
<div id= "servicestext">
    <h1 id ="servicestexto">Services</h1>
</div>

<div id ="servicescolumns" class="container">
<div class="row">
...
<div class="container">
  ...
  <div class = "row">
<div class="col-md-4 col-sm-4 col-4" id = "upperabout">
  <div id = "manphoto">
    <div id="realman" ></div>
    
  </div>
</div>    
<div class="col-md-8 col-sm-8 col-8" id="rightdiv">
<div id = "topabout"><h1>About WebReto</h1> </div>
<div id = "full1"> <p>‘Web’ represents the online element of a business and
  Reto' means the 'challenges' faced by the business.</p>
</div>
<div id = "full"> <p>We are a full service web development firm providing -</p>
<ul>

  <li>- Website design & development.</li>
  <li>- Mobile apps development.</li>
  <li>- Online business & analytics services.</li>
</ul>
</div>

<div id="para"><p> We offer high-end custom services to meet our clients' diverse needs and use latest 
  methods & tools to render a smooth end-user experience. </p>
</div>
  </div>
</div>  
...
<div id="heading"><h1>What People Say About Us</h1></div>
<div id="testimonials">
 
  <div class="carousel slide" id="myCarousel" data-ride="carousel">
    <ol class="carousel-indicators mycarousaclass">
...
?>
        <form action="index.php#footer" method="post" id=framework_form>
         <div class="form-group sizeo">
...
<div id ="copyright">
     ...
     <p>All Rights Reserved ©<a id= "sitelink" href="index.php">WebReto</a></p>
     </div>
</div>
</div>
<script>
